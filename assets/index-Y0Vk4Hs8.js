...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}]};function VA({openModal:o}){return Et.jsxs("section",{className:"section",children:[Et.jsx("h2",{children:"1. Conceptos Básicos"}),Et.jsx("h3",{children:"Fundamentos Visuales"}),Et.jsx("div",{className:"concepts-grid",children:A_.fundamentals.map(e=>Et.jsx(T_,{concept:e,onClick:()=>o(e)},e.id))}),Et.jsx("h3",{children:"Elementos de Producción 3D"}),Et.jsx("div",{className:"concepts-grid",children:A_.production.map(e=>Et.jsx(T_,{concept:e,onClick:()=>o(e)},e.id))})]})}function XA({era:o,onClick:e}){return Et.jsxs("div",{className:"timeline-item",onClick:e,children:[Et.jsx("h4",{children:o.title}),Et.jsx("p",{children:o.description}),Et.jsx("p",{className:"click-hint",children:"Click para ver más ›"})]})}const kA=[{id:"era1",title:"Primeros Pasos (1950–1970)",description:"Uso inicial en laboratorios militares y universidades. Primeras imágenes generadas por computador.",content:`
    ...
    `}];function WA({openModal:o}){return Et.jsxs("section",{className:"section",children:[Et.jsx("h2",{children:"2. Historia y Evolución"}),Et.jsx("div",{className:"timeline",children:kA.map(e=>Et.jsx(XA,{era:e,onClick:()=>o(e)},e.id))})]})}function qA({trend:o,onClick:e}){return Et.jsxs("div",{className:"trend-card",onClick:e,children:[Et.jsxs("h4",{children:[o.icon," ",o.title]}),Et.jsx("p",{children:o.description}),Et.jsx("p",{className:"click-hint",children:"Click para ver más ›"})]})}const YA=[{id:"realtime",icon:"🎮",title:"Render en Tiempo Real",description:"Motores como Unreal Engine y Unity permiten ver resultados instantáneos.",content:`
    ...
    `}];function jA({openModal:o}){return Et.jsxs("section",{className:"section",children:[Et.jsx("h2",{children:"3. Tendencias Actuales"}),Et.jsx("div",{className:"trend-grid",children:YA.map(e=>Et.jsx(qA,{trend:e,onClick:()=>o(e)},e.id))})]})}function ZA(){return Et.jsxs("footer",{className:"footer",children:[Et.jsx("p",{children:"INTRODUCCIÓN A LA COMPUTACIÓN VISUAL (CGI) – SESIÓN 1"}),Et.jsx("p",{children:"Este documento sirve como base conceptual para el módulo. En clase se reforzará con ejemplos visuales, ejercicios introductorios y discusiones sobre aplicaciones prácticas en producción audiovisual."})]})}function KA({content:o,onClose:e}){return mi.useEffect(()=>{const i=r=>{r.key==="Escape"&&e()};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[e]),Et.jsx("div",{className:"modal-overlay active",onClick:e,children:Et.jsxs("div",{className:"modal-content",onClick:i=>i.stopPropagation(),children:[Et.jsxs("div",{className:"modal-header",children:[Et.jsx("h3",{children:o.modalTitle||o.title}),Et.jsx("button",{className:"close-btn",onClick:e,children:"✕"})]}),Et.jsx("div",{className:"modal-body",dangerouslySetInnerHTML:{__html:o.content}})]})})}function QA(){const[o,e]=mi.useState(null),[i,r]=mi.useState(0),[l,u]=mi.useState(null),[d,h]=mi.useState(!0);mi.useEffect(()=>{const g=()=>{const S=document.documentElement.scrollTop,y=document.documentElement.scrollHeight-document.documentElement.clientHeight,b=S/y*100;r(b),b<=5||b>=90?h(!0):h(!1)};return window.addEventListener("scroll",g),()=>window.removeEventListener("scroll",g)},[]);const m=g=>{u(g),document.body.style.overflow="hidden"},p=()=>{u(null),document.body.style.overflow="auto"},v=g=>{e(g)};return o?Et.jsxs("div",{className:"app",children:[Et.jsx("div",{className:"bg-animation"}),Et.jsx("div",{className:"bg-grid"}),Et.jsx("div",{className:"scroll-indicator",style:{width:`${i}%`}}),Et.jsxs("button",{className:`back-to-menu-btn ${d?"visible":"hidden"}`,onClick:()=>e(null),children:[Et.jsx("span",{className:"back-arrow",children:"←"}),Et.jsx("span",{className:"back-text",children:"Volver al Menú"})]}),Et.jsxs("div",{className:"container",children:[Et.jsx(zA,{}),Et.jsx(GA,{}),Et.jsx(VA,{openModal:m}),Et.jsx(WA,{openModal:m}),Et.jsx(jA,{openModal:m}),Et.jsx(ZA,{})]}),l&&Et.jsx(KA,{content:l,onClose:p})]}):Et.jsx(PA,{onSelectSession:v})}yS.createRoot(document.getElementById("root")).render(Et.jsx(mi.StrictMode,{children:Et.jsx(QA,{})}));
